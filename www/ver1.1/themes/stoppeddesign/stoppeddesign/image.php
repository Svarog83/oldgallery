...
<html>
<head>
	<title><?php if (getOption('website_title') != '') { echo getOption('website_title') . '&#187; '; } ?><?php printGalleryTitle(); ?> &#187; <?php echo getAlbumTitle();?> &#187; <?php echo getImageTitle();?></title>
    ...
    <?php setOption('thumb_crop_width', 80, false);setOption('thumb_crop_height', 85, false);?>
</head>
