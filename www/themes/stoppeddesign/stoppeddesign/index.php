...
<head>
  <title><?php if (getOption('website_title') != '') { echo getOption('website_title') . '&#187; '; } ?><?php printGalleryTitle(); ?></title>
  <link rel="stylesheet" href="<?php echo  $_zp_themeroot ?>/css/master.css" type="text/css" />
  <?php printRSSHeaderLink('Gallery','Gallery RSS'); zenJavascript(); ?>
</head>
...
<p id="path"><?php if (getOption('website_url') != '') { ?> <a href="<?php echo zp_conf('website_url'); ?>" title="Back"><?php echo getOption('website_title'); ?></a> &#187; <?php } ?>
